...
android {
    namespace = "com.xtguiyi.featurecollection"
    ...
    defaultConfig {
        ...
        applicationId = "com.xtguiyi.featurecollection"
    ...
    signingConfigs {
        create("release") {
            ...
            val storeFilePath = localProperties.getProperty("MYAPP_RELEASE_STORE_FILE")
